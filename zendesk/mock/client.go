...
//
//	mockgen -source=api.go -destination=mock/client.go -package=mock -mock_names=API=Client github.com/esqimo/go-zendesk/zendesk API
//
...
import (
	...
	zendesk "github.com/esqimo/go-zendesk/zendesk"
